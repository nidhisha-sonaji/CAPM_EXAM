...
using { ust.nidhisha.sonaji.commons2 as common} from './commons2'; 
...
context master1 {
    ...
    entity product{
        ...
        SUPPLIER_GUID: Association to master1.businesspartner;
...
context transaction {
    entity purchaseorder: common.Amount{
        ...
        PARTNER_GUID: Association to master1.businesspartner  @title : '{i18n>PARTNER_KEY}';
    ...
    entity poitems: common.Amount{
        ...
        PRODUCT_GUID: Association to master1.product  @title : '{i18n>PRODUCT_ID}';
    }
}